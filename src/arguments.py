...
parser.add_argument("--train_size", type=int, help="n train data", default=600)
...
parser.add_argument(
    "--max_collectors", help="max Collector workers", type=int, default=8
)
parser.add_argument(
    "--max_evaluators", help="max Evaluator workers", type=int, default=2
)
